...
function evaluate(jobCategoryId, postcodeWorkCats, businessName) {
  ...
  // Secondary processing check ONLY applies to specified work (farming, mining, construction).
  // Tourism/hospitality businesses are never secondary processors — a "Mill Restaurant"
  // or "Coral Bay Brewing Co bar" is legitimate tourism work in a Cat 1/2 postcode.
  if (businessName && nature === 'specified') {
